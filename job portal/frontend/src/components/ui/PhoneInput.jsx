...
const PhoneInput = React.forwardRef(({
    ...
    const variantStyles = {
    default: "border-gray-300 hover:border-gray-400 focus:ring-1 focus:ring-[#9bc87c] focus:border-[#9bc87c]",
    error: "border-red-500 bg-red-50 focus:ring-1 focus:ring-red-400 focus:border-red-500",
    disabled: "border-gray-300 bg-gray-50 cursor-not-allowed"
};
