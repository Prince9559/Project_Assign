...
const Select = React.forwardRef(({
    ...
    const variantStyles = {
        default: "border-gray-300 hover:border-[#9bc87c] focus:outline-none focus:ring-2 focus:ring-[rgba(155,200,124,0.3)] focus:border-[#9bc87c]",
        error: "border-red-500 bg-red-50 focus:outline-none focus:ring-2 focus:ring-[rgba(239,68,68,0.25)] focus:border-red-500",
