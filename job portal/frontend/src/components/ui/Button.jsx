...
const Button = ({
    ...
    // };
const variantStyles = {
    primary: "bg-[#9bc87c] text-[#1e1e2d] hover:bg-[#8ab76b]",
    secondary: "bg-[#eaf4e3] text-[#2f5d2f] hover:bg-[#d8ecc7]",
    outline: "border border-[#9bc87c] text-[#2f5d2f] bg-white hover:bg-[#f3f9ee]",
    danger: "bg-red-500 text-white hover:bg-red-600"
};
