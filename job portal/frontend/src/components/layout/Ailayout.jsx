...
export default function AiLayout({
    ...
    return (
        <div className="w-full min-h-screen bg-white overflow-hidden relative flex flex-col ">
            {/* Logo */}
            ...
            <div
                className="absolute top-0 left-0 w-full h-[85vh] bg-[#1DB32F] z-0 pointer-events-none"
                style={{
