    ...
    <div className="w-full bg-[#D1E7FF] py-16 flex flex-col items-center">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        {/*Enterprice */}
         {/* Pro Plan */}
        <div className="bg-white w-[320px] rounded-2xl shadow-md overflow-hidden border-2 border-[#DFDAF8]">
          <div className="bg-[#FFE3E0] py-3 px-6">
            <h5 className="text-[#FD9801] font-bold text-xl">Enterprice</h5>
          </div>
          ...
          <div className="px-6 py-6 space-y-3">
            ...
            <h1 className="text-[#FD9801] font-bold text-4xl mt-4">
              ₹499/Year
            </h1>

            <button className="bg-[#FD9801] w-full py-3 rounded-lg text-white font-semibold mt-3">
              Explore now
            </button>
          </div>
        </div>
