...
const Hero = () => {
  return (
    <div className="w-full min-h-60 bg-white flex flex-col items-center justify-center px-10 text-center bg-gradient-to-b from-[#D1E7FF]/70 via-[#F9F9FA]/10 to-transparent blur-s pointer-events-none">

      {/* Headings */}
      <h3 className="text-4xl md:text-5xl font-bold text-[#032466] mb-3">
        Discover Talent That Delivers.
      </h3>

      <h5 className="text-lg md:text-xl text-gray-700">
        Connect with Pre-Skilled, Verified, and Job-Ready Candidates.
      </h5>
