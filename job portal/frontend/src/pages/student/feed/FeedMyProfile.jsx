  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      ...
      try {
        ...
        if (user_id) {
          const response= await getUserPublicProfile(user_id, token);
      ...
      <div className="flex justify-center min-h-screen px-2 bg-gray-100 lg:px-8">
        ...
        <section className="w-[800px] max-w-[800px] p-2 mt-2 mx-auto bg-white">
          ...
          <div className="pt-6 mb-6 text-gray-400 border-t">
            <p className="mb-4 text-sm text-gray-600">Recent posts</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            ...
                            <div>
                              <button onClick={() => navigate("/feed-your-experience")}>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-col sm:flex-row sm:justify-between">
                            ...
                            <div>
                              <button onClick={() => navigate("/feed-your-education")}>
                                <FaEllipsisH className="mt-2 text-gray-400 cursor-pointer sm:mt-0" />
                            </button>
                            </div>
                          </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex flex-col sm:flex-row sm:justify-between">
                              ...
                              <div>
                                <button onClick={() => navigate("/feed-your-skills")}>
                              <FaEllipsisH className="mt-2 text-gray-400 cursor-pointer sm:mt-0" />
                              </button>
                              </div>
                            </div>
