...
const RecruiterPendingEmployeeApprovals = () => {
  ...
  return (
    <MainLayout>
      <div className="p-6 bg-gray-100 min-h-screen">
        <h1 className="text-2xl font-bold mb-4">Company - Pending Employee Approvals</h1>
...
export default RecruiterPendingEmployeeApprovals;
